...
if(isset($_GET['idZ'])  && !isset($_GET['idM'])){
    getZoneValue($conn);
    echo"<script>
   location.href='./tbpage5.php?m=".$m."&y=".$y."&id='+myjson+'&idZ='+myjson1;\n
</script>";
}
if(isset($_GET['idM'])){
    getZoneValue($conn);
    getModuleValue($conn);
    echo"<script>
    location.href='./tbpage5.php?m=".$m."&y=".$y."&id='+myjson+'&idZ='+myjson1+'&idM='+myjson2;\n
</script>";
}
if(!isset($_GET['idZ'])  && !isset($_GET['idM'])){
    echo"<script>
    location.href='./tbpage5.php?m=".$m."&y=".$y."&id='+myjson;\n
    </script>";
}
